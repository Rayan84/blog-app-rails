...
RSpec.describe 'posts index page', type: :feature do
  scenario 'Check the existence of user profile picture, username, number posts, post title, post body, comments, number of comments, first comment, number of posts, number of likes, pagination, post link functionality' do
