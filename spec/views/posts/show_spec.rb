...
RSpec.describe 'Posts show', type: :feature do
  scenario 'Check the existence of the current post title, author name, number of comments, number of likes, post body, username of commentor, comments text' do
